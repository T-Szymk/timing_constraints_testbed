...
create_generated_clock -name clkdiv1 -source [get_pins clk_div_2_r_reg/C] -divide_by 2 [get_pins clk_div_2_r_reg/Q]

create_generated_clock -name mux0i0 -divide_by 1 -add -master_clock clkdiv1 -source [get_pins i_BUFGMUX0/I0] [get_pins i_BUFGMUX0/O]
create_generated_clock -name mux0i1 -divide_by 1 -add -master_clock clk_out1_clk_wiz_0 -source [get_pins i_BUFGMUX0/I0] [get_pins i_BUFGMUX0/O]

create_generated_clock -name clkdiv2 -source [get_pins  i_counter0/div_clk_r_reg/C] -divide_by 2 [get_pins i_counter0/div_clk_r_reg/Q]

create_generated_clock -name mux1i0_mux0i0 -divide_by 1 -add -master_clock mux0i0 -source [get_pins i_BUFGMUX1/I0] [get_pins i_BUFGMUX1/O]
create_generated_clock -name mux1i0_mux0i1 -divide_by 1 -add -master_clock mux0i1 -source [get_pins i_BUFGMUX1/I0] [get_pins i_BUFGMUX1/O]
create_generated_clock -name mux1i1 -divide_by 1 -add -master_clock clkdiv2 -source [get_pins i_BUFGMUX1/I1] [get_pins i_BUFGMUX1/O]

set_clock_groups -physically_exclusive -group mux0i0 -group mux0i1 
set_clock_groups -physically_exclusive -group mux1i0_mux0i0 -group mux1i0_mux0i1 -group mux1i1

## Switches
set_property -dict {PACKAGE_PIN A8 IOSTANDARD LVCMOS33}  [get_ports {sw_in[0]}]
set_property -dict {PACKAGE_PIN C11 IOSTANDARD LVCMOS33} [get_ports {sw_in[1]}]
...
set_false_path -from sw_in[0];
set_false_path -from sw_in[1];
